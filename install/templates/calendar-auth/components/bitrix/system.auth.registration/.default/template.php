        ...
        <div class="columns is-mobile is-centered">
            <div class="column is-two-fifths has-text-centered login">
                ...
                <form method="post" action="" name="bform" enctype="multipart/form-data">
                    ...
                    <!--			<td><input type="text" name="USER_NAME" maxlength="50" value="-->
                    <? //=$arResult["USER_NAME"]?><!--" class="bx-auth-input" /></td>-->
                    <!--		</tr>-->
                    <!--		<tr>-->
                    <!--			<td>--><? //=GetMessage("AUTH_LAST_NAME")?><!--</td>-->
                    <!--			<td><input type="text" name="USER_LAST_NAME" maxlength="50" value="-->
                    ...
                    <? //=GetMessage("AUTH_LOGIN_MIN")?><!--</td>-->
                    <!--			<td><input type="text" name="USER_LOGIN" maxlength="50" value="-->
                    <? //=$arResult["USER_LOGIN"]?><!--" class="bx-auth-input" /></td>-->
                    <!--		</tr>-->
                    <div class="field">
                    ...
                    <!--		<tr>-->
                    <!--			<td><span class="starrequired">*</span>-->
                    <? //=GetMessage("AUTH_PASSWORD_REQ")?><!--</td>-->
                    <!--			<td><input type="password" name="USER_PASSWORD" maxlength="255" value="-->
                    <? //=$arResult["USER_PASSWORD"]?><!--" class="bx-auth-input" autocomplete="off" />-->
                    <div class="field">
				...
				<span class="bx-auth-secure" title="<? echo GetMessage("AUTH_NONSECURE_NOTE") ?>">
                    ...
                    <!--		<tr>-->
                    <!--			<td><span class="starrequired">*</span>-->
                    <? //=GetMessage("AUTH_CONFIRM")?><!--</td>-->
                    <!--			<td><input type="password" name="USER_CONFIRM_PASSWORD" maxlength="255" value="-->
                    <? //=$arResult["USER_CONFIRM_PASSWORD"]?><!--" class="bx-auth-input" autocomplete="off" /></td>-->
                    <!--		</tr>-->
                    <div class="field">
                ...
                <p class="description register-pass"><span class="starrequired">*</span><?= GetMessage("AUTH_REQ") ?>
                </p>
                ...
                <br/>
                <small><em>Уже есть аккаунт? </em><a href="<?= $arResult["AUTH_AUTH_URL"] ?>"
                                                     rel="nofollow"><b><?= GetMessage("AUTH_AUTH") ?></b></a></small>
                <!--<p><a href="--><? //=$arResult["AUTH_AUTH_URL"]?><!--" rel="nofollow"><b>-->
                <? //=GetMessage("AUTH_AUTH")?><!--</b></a></p>-->
