...
<!--		<tr>-->
	...
	<div class="field">
		...
		<div class="control">
			<input class="input bx-auth-input" type="text" name="USER_NAME" value="<?=$arResult["USER_NAME"]?>"/>
		</div>
	</div>
...
<!--		</tr>-->
	<div class="field">
		...
		<div class="control">
			<input class="input bx-auth-input" type="text" name="USER_LAST_NAME" value="<?=$arResult["USER_LAST_NAME"]?>"/>
		</div>
	</div>
...
<!--		</tr>-->
	<div class="field">
		<label class="label"><span class="starrequired">*</span><?=GetMessage("AUTH_LOGIN_MIN")?></label>
		<div class="control">
			<input class="input bx-auth-input" type="text" name="USER_LOGIN" value="<?=$arResult["USER_LOGIN"]?>"/>
		</div>
	</div>
...
<!--			<td><input type="password" name="USER_PASSWORD" maxlength="255" value="--><?//=$arResult["USER_PASSWORD"]?><!--" class="bx-auth-input" autocomplete="off" />-->
	<div class="field">
		<label class="label"><span class="starrequired">*</span><?=GetMessage("AUTH_PASSWORD_REQ")?></label>
		<div class="control">
			<input class="input bx-auth-input" type="password" name="USER_PASSWORD" value="<?=$arResult["USER_PASSWORD"]?>" autocomplete="off"/>
		</div>
	</div>
...
<!--		</tr>-->
	<div class="field">
		<label class="label"><span class="starrequired">*</span><?=GetMessage("AUTH_CONFIRM")?></label>
		<div class="control">
			<input class="input bx-auth-input" type="password" name="USER_CONFIRM_PASSWORD" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" autocomplete="off"/>
		</div>
	</div>
...
<!--		</tr>-->
	<div class="field">
		<label class="label"><?if($arResult["EMAIL_REQUIRED"]):?><span class="starrequired">*</span><?endif?><?=GetMessage("AUTH_EMAIL")?></label>
		<div class="control">
			<input class="input bx-auth-input" type="text" name="USER_EMAIL" value="<?=$arResult["USER_EMAIL"]?>"/>
		</div>
	</div>
<?endif?>
...
<!--			<td></td>-->
	<br/>
			<input class="button is-block is-primary is-fullwidth is-medium" type="submit" name="Register" value="<?=GetMessage("AUTH_REGISTER")?>" />
	<br/>
	<!--		</tr>-->
<!--	</tfoot>-->
<!--</table>-->
...
<p class="description register-pass"><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></p>
<p class="description register-pass"><span class="starrequired">*</span><?=GetMessage("AUTH_REQ")?></p>

<!--<p>--><?//echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?><!--</p>-->
<!--<p><span class="starrequired">*</span>--><?//=GetMessage("AUTH_REQ")?><!--</p>-->

<br />
<small><em>Уже есть аккаунт? </em><a href="<?=$arResult["AUTH_AUTH_URL"]?>" rel="nofollow"><b><?=GetMessage("AUTH_AUTH")?></b></a></small>
