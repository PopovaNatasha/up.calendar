	...
	<form name="form_auth" method="post" target="_top" action="/auth">
		...
		<div class="field">
			<div class="control has-icons-left">
				<input class="input bx-auth-input form-control" type="text" placeholder="Логин" name="USER_LOGIN" value="<?=$arResult["LAST_LOGIN"]?>">
		...
		<div class="field">
			<p class="control has-icons-left">
				<input class="input bx-auth-input form-control" type="password" placeholder="Пароль" name="USER_PASSWORD" autocomplete="off">
				<span class="icon is-small is-left">
...
<?endif?>
				<div class="authorize-submit-cell">
					<input type="submit" class="button is-block is-primary is-fullwidth btn btn-primary" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" />
				</div>
